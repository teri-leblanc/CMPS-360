    ...
    public void run(){
        ...
        try{
            while(true){
                ...
                else if(readMessage.equals("true")){} // true is sent upon first connection.
                else if(readMessage.equals("agent")){} // agent is sent when the agent connects.
                else if(readMessage.equals("\n")){} // ignore character.
                else if(readMessage.equals("")){} // ignore character.
                else{
